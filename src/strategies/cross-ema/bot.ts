...
export interface CrossEMAOptions extends DebutOptions, SessionPluginOptions, VirtualTakesOptions {
  fastPeriod: number;
  slowPeriod: number;
  openPercent: number;
}
 ...
 */
export class CrossEMABot extends Debut {
  ...
  constructor(transport: BaseTransport, public opts: CrossEMAOptions) {
